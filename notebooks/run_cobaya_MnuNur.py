...
emudir = "/work/bk935060/Looti/looti/emulators/MnuNurTau_cmb_5sigma_%i_npca15" %(n_train)
savedir = "/work/bk935060/Looti/cobaya/looti_TTTEEE_MnuNurTau_5sigma_%i_npca15/chains/" %(n_train)
...
info = {
    ...
    'params': {
                ...
                'm_ncdm': {'latex': 'm_\\mathrm{\\nu}',
                           'prior': {'max':0.06 + sigma * 0.06, 'min': 0.06 - sigma * 0.06},
                           'proposal': 0.003,
                           'ref': {'dist': 'norm', 'loc': 0.06, 'scale':0.003}
                           },
                'N_ur': {'latex': 'N_\\mathrm{ur}',
                         'prior': {'max':1.0 + sigma * 0.18, 'min': 0.0 - sigma * 0.18},
                         'proposal': 0.03,
                         'ref': {'dist': 'norm', 'loc': 1.0, 'scale':0.03}
                         },
                'A_planck': 1.0
    },  
    "sampler": { 
