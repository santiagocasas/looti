...
from looti.example import classes, hello, math
...
class ClassesTestCase(TestCase):
    ...
    def test_luminosity(self):
        """Test ``looti.example.classes.StefBoltz.luminosity`` method.

        See Also
        --------
        looti.example.classes.StefBoltz : Implementation of the
            ``StefBoltz`` class.
...
class HelloTestCase(TestCase):
    ...
    def test_hello_world(self):
        """Test ``looti.example.hello.hello_world`` function.

        See Also
        --------
        looti.example.hello.hello_world : Implementation of the
...
class MathTestCase(TestCase):
    ...
    def test_add_two_ints(self):
        """Test ``looti.example.math.add_two_ints`` function.

        See Also
        --------
        looti.example.math.test_add_two_ints : Implementation of the
    ...
    def test_drake_equation(self):
        """Test ``looti.example.math.drake_equation`` function.

        See Also
        --------
        looti.example.math.drake_equation : Implementation of the
    ...
    def test_mad(self):
        """Test ``looti.example.math.mad`` function.

        See Also
        --------
        looti.example.math.mad : Implementation of the
            ``mad`` function.
